      ...
      <div class="row">
        <div class="col-md-5 col-md-offset-3 column">
          <form role="form" id="signupform" method="post" action="hi.php">
            ...
            <div class="row">
              <div class="col-lg-4">
                <label for="fname">First Name</label> <span id="fnamewarn"></span><input type="text" class="form-control" id="fname" name="fname" />
              </div>
              <div class="col-lg-4">
                <label for="mname">Middle Name</label><span id="mnamewarn"></span><input type="text" class="form-control" id="mname" name="mname"/>
              </div>
              <div class="col-lg-4">
                <label for="lname">Last Name</label> <span id="lnamewarn"></span><input type="text" class="form-control" id="lname" name="lname"/>
              </div>
            </div>
            <div class="form-group">
              <label for="email">Email Address</label> <span id="emailwarn" style="font-weight:bold;"></span><input type="email" class="form-control" id="email" name="email"/>
              <input type="hidden" class="form-control" id="emailcheck" name="emailcheck" value="0"/>
            </div>
            <div class="form-group">
              <label for="phone">Phone Number</label> <span id="phonewarn" style="font-weight:bold;"></span><input type="text" class="form-control" id="phone" name="phone"/>
              <input type="hidden" class="form-control" id="phonecheck" name="phonecheck" value="0"/>
            </div>
            <div class="form-group">
              <label for="addr">Address</label> <span id="addrwarn"></span ><input type="text" class="form-control" id="addr" name="addr"/>
            </div>
            <div class="row">
              <div class="col-lg-5">
                <label for="city">City</label> <span id="citywarn"></span><input type="text" class="form-control" id="city" name="city"/>
              </div>
              <div class="col-lg-4">
              ...
              <div class="col-lg-3">
                <label for="zip">Zip Code</label> <span id="zipwarn"></span><input type="text" class="form-control" id="zip" name="zip"/>
              </div>
            </div>
            <br/>
            ...
            <script>
              ...
              $('#username').on('focus', function () {
                $("#userwarn").html("Maximum 20 Charactors");
              });
              ...
              $('#sgnupsubmit').click(function() {
                if(!$("#username").val() || !$("#password").val() || $("#pwdconfirm").val() != $("#password").val()){
                  $('#signupnotice').modal('show');
                  var alert='';
                  if(!$("#username").val()){alert = '● Username </br>';}
                  if(!$("#password").val()){alert += '● Password </br>';}
                  if($("#pwdconfirm").val() != $("#password").val()){alert += '● Confirm Password </br>';}
              ...
              $('#signupbtn').click(function(){
                ...
                $("#signupform").on("submit", function(e) {
                  ...
                  $.post( formURL, { act:'signup', fname:$('#fname').val(), mname:$('#mname').val(), lname:$('#lname').val(), username:$('#username').val(),password:$('#password').val(), email:$('#email').val(), phone:$('#phone').val(), addr:$('#addr').val(), city:$('#city').val(), state:$('#state').val(), zip:$('#zip').val()}, function (data){              
                    $('#signupmodal .modal-title').html("Registration Complete"); 
